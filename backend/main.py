...
async def chat_endpoint(req: ChatRequest):
    ...
    system_prompt = {
        ...
        "content": (
            ...
            "2. The response must be provided in markdown (.md) format.\n\n"
            "3. After the response, provide a Chain-of-Thought (COT) reasoning in JSON format.\n"
            "4. The JSON array must start with '```json' and end with '```'.\n"
            "5. Each reasoning step must include a 'title' and 'details' field.\n\n"
            "6. The Chain-of-Thought must be sufficiently transparent and specific to the query for the user to understand the logic.\n\n"
            "Example COT format:\n"
            "```json\n"
            "[\n"
